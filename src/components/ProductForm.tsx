  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-sm rounded-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-display">Post a Crop Listing</DialogTitle>
        </DialogHeader>
        <div className="space-y-3">
          <p className="text-[11px] text-muted-foreground bg-secondary/40 rounded-xl p-2">
            Your listing goes live after admin review. We may polish wording, units & pricing for
            buyers.
          </p>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <Select value={category} onValueChange={setCategory}>
                ...
                <SelectContent>
                  {["Cereals", "Legumes", "Vegetables", "Fruits", "Tubers", "Coffee", "Other"].map(
                    (c) => (
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <Select value={unit} onValueChange={setUnit}>
                ...
                <SelectContent>
                  {["Bags", "Sacks", "Kilograms", "Tonnes"].map((u) => (
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <Select value={grade} onValueChange={setGrade}>
                ...
                <SelectContent>
                  {["Grade A", "Grade B", "Grade C", "Mixed"].map((g) => (
            ...
            <div>
              ...
              <Select value={organic} onValueChange={setOrganic}>
                ...
                <SelectContent>
                  {["Organic", "Conventional", "In Transition"].map((o) => (
